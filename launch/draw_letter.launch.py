"""Launch a letter-drawing node against an already running simulation."""
...
def generate_launch_description() -> LaunchDescription:
    arguments = [
        ("letter", "A"), ("scale", "0.13"), ("center_x", "0.30"), ("center_y", "0.0"),
        ("draw_height", "0.30"), ("lift_height", "0.36"), ("frame_id", "base_link"),
    ]
    node = Node(
        package="ur_drawing", executable="letter_drawer", output="screen",
